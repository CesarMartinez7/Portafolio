...
const tools: Tool[] = [
  ...
  { name: "javascript", color: "#F7DF1E", link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript" },
  ...
  { name: "html5", color: "#E34F26", link: "https://developer.mozilla.org/en-US/docs/Web/Guide/HTML/HTML5" },
